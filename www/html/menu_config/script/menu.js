...
function getRequestAttachXml(userId, templateId, islands){
	var ret = "";
	ret += "<Request>";
...
//// GET REQUEST-XML OF SET TEMPLATE API ////
function getRequestSetTemplateXml(userId, templateId, templateName, menu){
	var ret = "";
	ret += "<Request>";
	ret += "	<userId>" + userId + "</userId>";
	ret += "	<templateId>" + templateId + "</templateId>";
